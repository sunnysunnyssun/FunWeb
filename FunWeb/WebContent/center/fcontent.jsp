...
if(bb.getType()==1){
	...
	<%=bb.getFile() %> <a href="file_down.jsp?file_name=<%=bb.getFile() %>"> 다운로드</a>	
	...
	%>
	<tr><th class="twrite">그림</th><td colspan="3">
	<a href="../upload/<%=bb.getFile() %>"><img src="../upload/<%=bb.getFile() %>" width="200"></a><br>
	<%=bb.getFile() %> <a href="file_down.jsp?file_name=<%=bb.getFile() %>"> 그림다운받기 </a>	
	</td></tr>
	<% 
}
%>
