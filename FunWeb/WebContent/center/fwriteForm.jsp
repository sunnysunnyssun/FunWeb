...
// enctype="multipart/form-data" 꼭 넣기. 파일 첨부가 되는 폼에는 해당 폼 옵션을 꼭 추가해줘야함. 아닌 폼에는 꼭 빼줘야함
...
<form action="fwritePro.jsp" method="post" name="" enctype="multipart/form-data">
...
<tr><td class="twrite">제목</td>
    <td class="ttitle" colspan="3"><input type="text" name="subject" size="78"></td>
</tr>
